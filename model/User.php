...
class User extends UserBase {
    ...
    public function updateUser($email, $user, $first_name, $last_name, $pass) {
        $connection = Connection::getInstance();
        
        $query = $connection->prepare("UPDATE usuario SET updated_at=:updated, email=:email, username=:user, first_name=:first_name, last_name=:last_name, password=:pass WHERE id=:id");
